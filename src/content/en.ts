...
export const en: SiteContent = {
  common: {
    ...
    footer: {
      ...
      credit: "© 2026 All rights reserved. Proudly built by Brandstone.",
    },
  ...
  coachesData: [
    { name: "Jamila de Jong-van der Schaaf", role: "Owner & coach" },
    { name: "Volke Hoekstra", role: "Coach & trainer" },
    { name: "Siebe Slagter", role: "Consultant & coach" },
